 ...
 */
public class Email {
    public static void sendEmail(String subject, String message, String recepient) {

        // Сюда необходимо подставить адрес получателя сообщения
        String to = recepient;
        String from = "bezobidya@yandex.ua";
        // Сюда необходимо подставить SMTP сервер, используемый для отправки
        String host = "smtp.yandex.ua";
        ...
        Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("bezobidya", "passw0rd");
            }
        });
