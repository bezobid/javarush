...
public class Solution
{
    ...
    public static class Cat
    {
        ...
        public String toString() {
            ...
            if (mother == null) mama = "no mother";
            else mama = "mother is " + mother.name;

            if (father == null) papa = "no father";
            else papa = "father is " + father.name;

            return "Cat name is " + name + ", " + mama + ", " + papa;
        }
    }
}
