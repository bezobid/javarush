...
public class Solution {
    ...
    public String getPartOfString(String string, String threadName) {
        ...
        {
            if (threadName.equals(FIRST_THREAD_NAME)) throw new TooShortStringFirstThreadException(e.toString());
            else if (threadName.equals(SECOND_THREAD_NAME)) throw new TooShortStringSecondThreadException(e.toString());
            else {
