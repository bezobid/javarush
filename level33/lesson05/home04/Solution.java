...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        String name1 = one.getClass().getSimpleName().toLowerCase();
        String name2 = resultClassObject.getSimpleName().toLowerCase();

        String replaced = json.replaceFirst(name1, name2);
