...
public class Solution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new Thread("1") {
            ...
            public void run() {
                try {
                    System.out.println(currentThread().getName() + " : " + isNormalLockOrder(solution, o1, o2)); //expected boolean b
        ...
        new Thread("2") {
            ...
            public void run() {
                try {
                    System.out.println(currentThread().getName() + " : " + isNormalLockOrder(solution, o2, o1)); //expected boolean b
                } catch (Exception ignored) {
                }
            }
        }.start();
